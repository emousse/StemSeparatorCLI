...
class RangeSlider(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter.drawRoundedRect(
            track_left, center_y - track_height // 2,
            start_x - track_left, track_height,
            2, 2
        )
        ...
        end_x = track_left + (self._end_value * track_width)
        painter.drawRoundedRect(
            end_x, center_y - track_height // 2,
            track_right - end_x, track_height,
            2, 2
        )
        ...
        painter.drawRoundedRect(
            start_x, center_y - track_height // 2,
            end_x - start_x, track_height,
            2, 2
        )
