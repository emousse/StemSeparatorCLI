...
def create_icon(output_path: Path, size: int = 1024):
    ...
    for i in range(len(all_points_stem1) - 1):
        ...
        color = (r, g, b, 255)
        draw.line(
            [all_points_stem1[i], all_points_stem1[i + 1]], fill=color, width=line_width
        )
    ...
    for i in range(len(all_points_stem2) - 1):
        ...
        color = (r, g, b, 255)
        draw.line(
            [all_points_stem2[i], all_points_stem2[i + 1]], fill=color, width=line_width
        )
    ...
    for i in range(len(all_points_stem3) - 1):
        ...
        color = (r, g, b, 255)
        draw.line(
            [all_points_stem3[i], all_points_stem3[i + 1]], fill=color, width=line_width
        )
