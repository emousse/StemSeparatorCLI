...
def test_is_beatnet_available_false():
    ...
    with patch(
        "builtins.__import__", side_effect=ImportError("No module named 'BeatNet'")
    ):
        result = is_beatnet_available()
...
def test_calculate_loops_basic():
    ...
    loops = calculate_loops_from_downbeats(
...
def test_calculate_loops_four_bars():
    ...
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=4, audio_duration=16.0
    )
...
def test_calculate_loops_partial_last():
    ...
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=4, audio_duration=10.0
    )
...
def test_calculate_loops_single_bar():
    ...
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=1, audio_duration=5.0
    )
...
def test_calculate_loops_eight_bars():
    ...
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=8, audio_duration=20.0
    )
...
def test_calculate_loops_uneven_spacing():
    ...
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=2, audio_duration=10.0
    )
...
def test_calculate_loops_empty_downbeats():
    ...
    with pytest.raises(ValueError, match="No downbeats"):
        calculate_loops_from_downbeats(
            np.array([]), bars_per_loop=4, audio_duration=10.0
        )
...
@patch("pathlib.Path.exists")
def test_detect_beats_resampling(
    mock_exists, mock_resample, mock_sf_read, mock_predictor
):
...
def test_calculate_loops_very_short_audio():
    ...
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=4, audio_duration=1.0
    )
...
def test_calculate_loops_exact_fit():
    ...
    downbeats = np.array([0.0, 2.0, 4.0, 6.0, 8.0])
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=4, audio_duration=8.0
    )
...
def test_calculate_loops_many_small_loops():
    ...
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=1, audio_duration=10.0
    )
...
def test_calculate_loops_large_bars_per_loop():
    ...
    loops = calculate_loops_from_downbeats(
        downbeats, bars_per_loop=16, audio_duration=35.0
    )
...
if __name__ == "__main__":
    pytest.main(
        [__file__, "-v", "--cov=utils.beat_detection", "--cov-report=term-missing"]
    )
